...
<p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Consectetur ex ipsam labore quam architecto nihil!</p>
<button className='bg-blue-600 text-white rounded w-1/5 py-2'>Register Now</button>
  </div>
